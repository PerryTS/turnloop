...
impl Error {
    ...
    pub fn name(&self) -> &'static str {
        match self.kind {
            ...
            ErrorKind::WaitQueueTimeout => "MongoWaitQueueTimeoutError",
            ErrorKind::ServerSelectionTimeout => "MongoServerSelectionError",
            ErrorKind::OperationTimeout => "MongoOperationTimeoutError",
