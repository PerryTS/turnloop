...
/// ```
/// use turnloop_zstd_decoder::decoding::BlockDecodingStrategy;
///
/// # #[cfg(feature = "std")]
...
/// # #[cfg(not(feature = "std"))]
/// use turnloop_zstd_decoder::io::{Read, Write};
///
/// fn decode_this(mut file: impl Read) {
///     //Create a new decoder
///     let mut frame_dec = turnloop_zstd_decoder::decoding::FrameDecoder::new();
