...
server.on('request',(req,res)=>{
  const path=req.url;
  if (process.env.TURNLOOP_HTTP_TEST_TOKEN && req.method==='POST' && path==='/__turnloop_shutdown' && req.headers['x-turnloop-test-token']===process.env.TURNLOOP_HTTP_TEST_TOKEN) {
